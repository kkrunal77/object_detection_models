...
The default anchor parameters.
    ratios  = np.array([1.48], keras.backend.floatx()),

"""
AnchorParameters.default = AnchorParameters(
    sizes   = [32, 64, 128, 256, 512],
    strides = [8, 16, 32, 64, 128],
    ratios  = np.array([0.67, 0.67, 0.67], keras.backend.floatx()),
    scales  = np.array([2 ** 0, 2 ** (0.1 / 3.0), 2 ** (2.0 / 3.0), 6 ** (3.0 / 3.0)], keras.backend.floatx()),
)
