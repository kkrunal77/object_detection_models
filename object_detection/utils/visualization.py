...
def draw_caption(image, box, caption):
    ...
    # caption = f'{round((b[3]-b[1])/(b[2]-b[0]),3)} : {d[caption]}'
    # caption = f"{caption}:{d[caption]}"
    caption = f'ratio : {round((b[3]-b[1])/(b[2]-b[0]),3)}'
    print(caption)
    cv2.putText(image, caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255), 1)
    cv2.putText(image, caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (255, 0, 255), 1)
